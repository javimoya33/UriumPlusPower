...
if ( ! class_exists( 'Helper' ) ) {
	...
	class Helper {
		...
		// 		wp_enqueue_script(
		// 			'trx-addons-gutenberg-editor-ai-helper-panel',
		...
		function register_blocks() {
			...
			wp_register_style( 'trx-addons-gutenberg-editor-ai-helper-panel', trx_addons_get_file_url( TRX_ADDONS_PLUGIN_ADDONS . 'ai-helper/support/Gutenberg/blocks/build/index.css' ) );
			wp_register_script( 'trx-addons-gutenberg-editor-ai-helper-panel', trx_addons_get_file_url( TRX_ADDONS_PLUGIN_ADDONS . 'ai-helper/support/Gutenberg/blocks/build/index.js' ), array( 'wp-blocks', 'wp-element', 'wp-components', 'wp-plugins', 'wp-edit-post', 'wp-i18n' ) ); //, 'wp-editor'
			...
			register_block_type( 'trx-addons/ai-helper-panel', apply_filters( 'trx_addons_gb_map', array(
				...
				'editor_style' => 'trx-addons-gutenberg-editor-ai-helper-panel',
				'editor_script' => 'trx-addons-gutenberg-editor-ai-helper-panel',
				//'attributes'      => array(),
