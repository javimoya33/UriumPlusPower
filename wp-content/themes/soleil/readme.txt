...
Please install and activate it before starting to use the theme Soleil.
...
Theme documentation is available on https://soleil.axiomthemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Soleil is Fontello.
