...
if ( ! function_exists( 'soleil_tribe_events_get_css' ) ) {
	add_filter( 'soleil_filter_get_css', 'soleil_tribe_events_get_css', 10, 2 );
	function soleil_tribe_events_get_css( $css, $args ) {
