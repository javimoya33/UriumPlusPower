...
if ( ! function_exists( 'soleil_trx_addons_get_css' ) ) {
	add_filter( 'soleil_filter_get_css', 'soleil_trx_addons_get_css', 10, 2 );
	function soleil_trx_addons_get_css( $css, $args ) {
...
.sc_blogger.sc_blogger_portestate .post_meta_item.post_categories,
