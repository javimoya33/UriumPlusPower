...
if ( ! function_exists( 'soleil_woocommerce_get_css' ) ) {
	add_filter( 'soleil_filter_get_css', 'soleil_woocommerce_get_css', 10, 2 );
	function soleil_woocommerce_get_css( $css, $args ) {
...
$fdir = soleil_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
