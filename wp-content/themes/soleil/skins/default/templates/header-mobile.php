...
// Additional info
if ( soleil_is_off( soleil_get_theme_option( 'header_mobile_hide_info' ) ) ) {
	$soleil_info = soleil_get_theme_option( 'header_mobile_additional_info' );
	if ( '' != $soleil_info ) {
			...
			<div class="content_wrap">
				<div class="columns_wrap">
					<div class="sc_layouts_column sc_layouts_column_align_center sc_layouts_column_icons_position_left column-1_1"><div class="sc_layouts_item">
						<?php
						soleil_show_layout( $soleil_info );
						?>
						</div><!-- /.sc_layouts_item -->
	...
	<div class="content_wrap">
		<div class="columns_wrap columns_fluid">
			<div class="sc_layouts_column sc_layouts_column_align_left sc_layouts_column_icons_position_left sc_layouts_column_fluid column-1_3">
				<?php
				// Logo
				if ( soleil_is_off( soleil_get_theme_option( 'header_mobile_hide_logo' ) ) ) {
					?>
					<div class="sc_layouts_item">
						<?php
						set_query_var( 'soleil_logo_args', array( 'type' => 'mobile_header' ) );
				...
				if ( soleil_exists_trx_addons() ) {
					...
					if ( soleil_is_off( soleil_get_theme_option( 'header_mobile_hide_login' ) ) ) {
						ob_start();
						do_action(
							'soleil_action_login', array(
								'text_login'  => false,
								'text_logout' => false,
							)
						);
					...
					// Display cart button
					if ( soleil_is_off( soleil_get_theme_option( 'header_mobile_hide_cart' ) ) ) {
						ob_start();
					...
					if ( soleil_is_off( soleil_get_theme_option( 'header_mobile_hide_search' ) ) ) {
						ob_start();
						do_action(
