...
if ( ! soleil_storage_get( 'lazy_load_off' ) ) {
    soleil_storage_set( 'lazy_load_off', true );
		...
		data-details="<?php
			echo esc_attr( '<div class="post_details">'
								...
								. '<div class="post_description">'
									. $details
									. ( empty( $soleil_template_args['hide_excerpt'] )
										? '<div class="post_description_content">' . get_the_excerpt() . '</div>'
										: ''
										)
									. '<a href="' . esc_url( $link ) . '" class="theme_button post_readmore"><span class="post_readmore_label">' . esc_html__( 'Learn more', 'soleil' ) . '</span></a>'
								. '</div>'
							. '</div>'
						);
		?>"
...
>
    ...
    <div class="post_content_wrap">
        ...
        <?php if(empty( $soleil_template_args['hide_excerpt'])) { ?>
